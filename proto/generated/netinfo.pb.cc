...
static void InitDefaultsscc_info_NetInfo_netinfo_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_NetInfo_netinfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_NetInfo_netinfo_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_netinfo_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_netinfo_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_netinfo_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_netinfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_netinfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rnetinfo.proto\022\rmonitor.proto\"q\n\007NetInf"
  "o\022\014\n\004name\030\001 \001(\t\022\021\n\tsend_rate\030\002 \001(\002\022\020\n\010rc"
  "v_rate\030\003 \001(\002\022\031\n\021send_packets_rate\030\004 \001(\002\022"
  "\030\n\020rcv_packets_rate\030\005 \001(\002b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_netinfo_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_netinfo_2eproto_sccs[1] = {
  &scc_info_NetInfo_netinfo_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_netinfo_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_netinfo_2eproto = {
  false, false, descriptor_table_protodef_netinfo_2eproto, "netinfo.proto", 153,
  &descriptor_table_netinfo_2eproto_once, descriptor_table_netinfo_2eproto_sccs, descriptor_table_netinfo_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_netinfo_2eproto::offsets,
  file_level_metadata_netinfo_2eproto, 1, file_level_enum_descriptors_netinfo_2eproto, file_level_service_descriptors_netinfo_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_netinfo_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_netinfo_2eproto)), true);
namespace monitor {
namespace proto {
...
void NetInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_NetInfo_netinfo_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
